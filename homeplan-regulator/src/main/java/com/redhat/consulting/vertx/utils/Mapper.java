...
public class Mapper {
	...
	public static Ambiance toAmbiance(AmbianceDTO ambianceDTO) {
		Ambiance ambiance = null;
		if (ambianceDTO != null) {
			ambiance = new Ambiance();
			ambiance.setHousePlanId(ambianceDTO.getHousePlanId());
			ambiance.setSensorLocation(toSensorLocation(ambianceDTO.getSensorLocation()));
		}
		return ambiance;
	}
}
