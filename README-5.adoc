...
* Use JavaRX Vert.x API http://vertx.io/docs/#reactive[JavaRX API]
...
==== STEP 2 - Running the maven projects
* clone/unzip https://github.com/skoussou/vertx-reactive-workshop Branch *LAB 6*
...
*Note:* these projects are still using 2 profiles 
 ** Profile *Openshift*
 ** Profile *local* (default)

* Starting microservice locally 

[source, shell]
----
mvn clean compile vertx:run -Dvertx.runArgs="-cluster -Djava.net.preferIPv4Stack=true"
----

* Deploying microservice on OCP

See *README_AWS.adoc* for setting up the Openshift cluster in AWS

[source, shell]
----
mvn io.fabric8:fabric8-maven-plugin:3.5.25:setup -P openshift
----

==== STEP 3 - Changing Vert.x API to JavaRX API for PUB/SUB

* Modify verticles in *_sensor-generator_* maven project to utilize http://vertx.io/docs/#reactive[Vert.x JavaRX API]


* Modify verticles in *_device-management_* maven project to utilize http://vertx.io/docs/#reactive[Vert.x JavaRX API]


* Modify verticles in *_homeplan-regulator_* maven project to utilize http://vertx.io/docs/#reactive[Vert.x JavaRX API]
...
==== THIS POINT FORWARD OLD LAB-5 Content
