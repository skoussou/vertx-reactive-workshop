...
* Use resources at http://vertx.io/docs/vertx-web/java/[Vert.x Web] to create an HTTP server so that it exposes the services in port 8181 in the *_start()_* method of the *_MainVerticle.java_*. *_Note_*: For MacOs users, check this https://thoeni.io/post/macos-sierra-java/[link] to avoid long and blocking application startup time.
