...
* Create Content for verticles in *_sensor-generator_* maven project to complete the service
  ...
  ** Using resources at link:http://vertx.io/docs/vertx-core/java/#_the_theory around SEND/REPLY pattern Fix method *_getHomePlan()_* to send the given homeplan id to address *_#homeplan_*
  ...
  ** Using resources at link:http://vertx.io/docs/vertx-core/java/#_the_theory around SEND/REPLY pattern Fix method *_getDeviceStatus()_* to send the given sensor id to address *_#device-data_*
